var app = (function() {
            ...
            m.$on("click", e[4]), {
                c() {
                    ...
                    Q(i.$$.fragment),
                        ...
                        (l = x()),
                        (u = w("h1")),
                        (u.textContent = "Canserbero Heardle"),
                        (c = x()),
                        (d = w("div")),
                        Q(h.$$.fragment),
                        (f = x()),
        ...
        return (
            (u = new Bt({})), {
                c() {
                    ...
                    (s = w("p")),
                    (n.innerHTML =
                        "Si te ha gustado el juego y quieres apoyarlo, compártelo con tus amigos!"),
                    (r = x()),
                    (s = w("p")),
                    (s.innerHTML =
                        'También puedes visitar el <a href="https://heardle.leonmartin.cc/robe/?utm_source=extremoduro-heardle&utm_medium=banner">Heardle de Robe</a>'),
                    (i = x()),
                    (o = w("div")),
                    //Q(a.$$.fragment),
                    (l = x()),
            ...
            (S = new qt({})), {
                c() {
                    ...
                    W.c(),
                        ...
                        (m = w("div")),
                        (k = w("div")),
                        (k.textContent = "Próxima canción en:"),
                        (b = x()),
                        Q(S.$$.fragment),
                        (D = x()),
                        (T = w("div")),
                        (Y = w("div")),
                        (Y.innerHTML =
                            '<p>Si te ha gustado, también puedes jugar al <a href="https://heardle.leonmartin.cc/extremoduro/?utm_source=canserbero-heardle&utm_medium=banner">Heardle de Extremoduro</a></p>'),
                        (C = x()),
                    ...
                    M(Y, "class", "flex justify-center items-center"),
    ...
    function an(e) {
        ...
        return {
            c() {
                (t = _("Adivinaste la canción de hoy en ")),
                (n = _(s)),
                (r = _(" segundos."));
            },
            m(e, s) {
    ...
    function un(t) {
        ...
        return {
            c() {
                n = _("No adivinaste la canción de hoy.");
            },
            m(e, t) {
                g(e, n, t);
            },
        ...
        return (
            ...
            [
                ...
                () => {
                    ...
                    let e = "Canserbero Heardle #" + (s.id + 1),
                        t = "";
                    a
                        ?
                    ...
                    let o =
                        ...
                        t +
                        "\n\n" +
                        "https://heardle.leonmartin.cc/canserbero/";
                    if (
                        !navigator.share ||
    ...
    const Cn = ue([
        ...
        "Canserbero - De la vida como una película su tragedia, comedia y ficción",
        "Canserbero - El Mundo ya Se Acabó",
        "Canserbero - Llovía",
        "Canserbero - Martillos y Ruedas",
        "Canserbero - Pensando en Ti",
        "Canserbero And Apache - El Mundo Abc",
        "Canserbero - Is Canzoo",
        "Canserbero And Nicojp - Outro Chavo",
        "Canserbero - Corazones de Piedra",
        "Canserbero - Es Pico",
        "Canserbero - Y la Felicidad Qué",
        "Canserbero - Maquiavélico",
        "Canserbero And Apache - La del Estribo",
        "Canserbero And Apache - Level",
        "Canserbero - Perdón",
        "Canserbero And Nicojp - Intro Music",
        "Canserbero - Mucho Gusto",
        "Canserbero - Advertencia",
        "Canserbero - Ser Vero",
        "Canserbero - Guía Para la Acción",
        "Canserbero And Apache - Uno Por Ellas",
        "Canserbero - Vida",
        "Canserbero And Nicojp - Huno",
        "Canserbero - Así Mismo",
        "Canserbero - Cuando Vayas Conmigo",
        "Canserbero - CANpesino",
        "Canserbero - Zoo",
        "Canserbero - Aceptas",
        "Canserbero - Sigo Siendo el Rey",
        "Canserbero - A Dónde se Fue la Conciencia",
        "Canserbero - En el Valle de las Sombras",
        "Canserbero - Clima Tropical",
        "Canserbero - No Justice",
        "Canserbero And Nicojp - Seamos Honestos (Mars Voice Note)",
        "Canserbero - Visiones",
        "Canserbero - Epílogo",
        "Canserbero And Apache - Hasta Cuándo",
        "Canserbero - Prólogo",
        "Canserbero - La Voz",
        "Canserbero - CANción de la Prisión",
        "Canserbero And Apache - Ouroboros",
        "Canserbero - Despierta",
        "Canserbero - Sin Mercy",
        "Canserbero - La Hora del Juicio",
        "Canserbero - Ni de Oro Ni GoldFil",
        "Canserbero - Les Guste o No",
        "Canserbero - CAN you hear it",
        "Canserbero - PROlogo",
        "Canserbero - Quién Eres",
        "Canserbero - Únetenos",
        "Canserbero And Nicojp - No no",
        "Canserbero - Un Día en el Barrio",
        "Canserbero, Mcklopedia And Benzina - Corre",
        "Canserbero - Jeremías 17-5",
        "Canserbero - Epílogo",
        "Canserbero And Apache - Interludio",
        "Canserbero - Monte y Culebra",
        "Canserbero And Apache - Stop",
        "Canserbero - El Primer Trago",
        "Canserbero - Mañana Será Otro Día",
        "Canserbero - CANbiate",
        "Canserbero And Apache Featuring Oldtape - Ready (feat. Oldtape)",
        "Canserbero - Ley del Hielo",
        "Canserbero And Nicojp - Buenas Noches",
        "Canserbero - No Pueden Llamarse Muertos",
        "Canserbero And Apache - Apa y Can",
        "Canserbero - Ni de Oro ni de Goldfield",
        "Canserbero - From The Roof",
        "Canserbero - On Datop",
        "Canserbero - Y en un Espejo Vi",
        "Canserbero And Nicojp - RA Words",
        "Canserbero - Interludio K219",
        "Canserbero And Nicojp - Adivina",
        "Canserbero - Índigo",
        "Canserbero - Perdiendo la Fe",
        "Canserbero And Apache - Agradezco",
        "Canserbero - Epílogo",
        "Canserbero - Puño Arriba",
        "Canserbero - Rialaif",
        "Canserbero And Apache - Stupid Love Story",
        "Canserbero - De Mi Muerte",
        "Canserbero - Darealhipapitis",
        "Canserbero - Hace Falta Soñar",
        "Canserbero - Americanos",
        "Canserbero And Apache - Pónmela en el Aire",
    ...
    On = {
        subscribe: ue(
            [
                {
                  url: "https://soundcloud.com/canserberoofficial/cest-la-mort",
                  answer: "Canserbero - C'est La Mort"
                },
                {
                  url: "https://soundcloud.com/knserbero/de-la-vida-como-una-pelicula-su-tragedia-comedia-y-ficcion",
                  answer: "Canserbero - De la vida como una película su tragedia, comedia y ficción"
                },
                {
                  url: "https://soundcloud.com/canserberoofficial/el-mundo-ya-se-acabo",
                  answer: "Canserbero - El Mundo ya Se Acabó"
                },
                {
                  url: "https://soundcloud.com/canserberoofficial/llovia",
                  answer: "Canserbero - Llovía"
                },
                {
                  url: "https://soundcloud.com/canserberoofficial/martillos-y-ruedas",
                  answer: "Canserbero - Martillos y Ruedas"
                },
                {
                  url: "https://soundcloud.com/canserberoofficial/pensando-en-ti",
                  answer: "Canserbero - Pensando en Ti"
                },
                {
                  url: "https://soundcloud.com/canserberoofficial/el-mundo-abc",
                  answer: "Canserbero And Apache - El Mundo Abc"
                },
                {
                  url: "https://soundcloud.com/canserberoofficial/is-canzoo",
                  answer: "Canserbero - Is Canzoo"
                },
                {
                  url: "https://soundcloud.com/canserberoofficial/outro-chavo",
                  answer: "Canserbero And Nicojp - Outro Chavo"
                },
                {
                  url: "https://soundcloud.com/canserberoofficial/corazones-de-piedra",
                  answer: "Canserbero - Corazones de Piedra"
                },
                {
                  url: "https://soundcloud.com/canserberoofficial/es-pico",
                  answer: "Canserbero - Es Pico"
                },
                {
                  url: "https://soundcloud.com/canserberoofficial/y-la-felicidad-que",
                  answer: "Canserbero - Y la Felicidad Qué"
                },
                {
                  url: "https://soundcloud.com/canserberoofficial/maquiavelico",
                  answer: "Canserbero - Maquiavélico"
                },
                {
                  url: "https://soundcloud.com/canserberoofficial/la-del-estribillo",
                  answer: "Canserbero And Apache - La del Estribo"
                },
                {
                  url: "https://soundcloud.com/canserberoofficial/level",
                  answer: "Canserbero And Apache - Level"
                },
                {
                  url: "https://soundcloud.com/canserberoofficial/perdon",
                  answer: "Canserbero - Perdón"
                },
                {
                  url: "https://soundcloud.com/canserberoofficial/intro-music",
                  answer: "Canserbero And Nicojp - Intro Music"
                },
                {
                  url: "https://soundcloud.com/canserberoofficial/mucho-gusto",
                  answer: "Canserbero - Mucho Gusto"
                },
                {
                  url: "https://soundcloud.com/canserberoofficial/advertencia",
                  answer: "Canserbero - Advertencia"
                },
                {
                  url: "https://soundcloud.com/canserberoofficial/ser-vero",
                  answer: "Canserbero - Ser Vero"
                },
                {
                  url: "https://soundcloud.com/canserberoofficial/guia-para-la-accion",
                  answer: "Canserbero - Guía Para la Acción"
                },
                {
                  url: "https://soundcloud.com/canserberoofficial/uno-por-ellas",
                  answer: "Canserbero And Apache - Uno Por Ellas"
                },
                {
                  url: "https://soundcloud.com/canserberoofficial/vida",
                  answer: "Canserbero - Vida"
                },
                {
                  url: "https://soundcloud.com/canserberoofficial/huno",
                  answer: "Canserbero And Nicojp - Huno"
                },
                {
                  url: "https://soundcloud.com/canserberoofficial/asi-mismo",
                  answer: "Canserbero - Así Mismo"
                },
                {
                  url: "https://soundcloud.com/canserberoofficial/cuando-vayas-conmigo",
                  answer: "Canserbero - Cuando Vayas Conmigo"
                },
                {
                  url: "https://soundcloud.com/canserberoofficial/canpesino",
                  answer: "Canserbero - CANpesino"
                },
                {
                  url: "https://soundcloud.com/canserberoofficial/zoo",
                  answer: "Canserbero - Zoo"
                },
                {
                  url: "https://soundcloud.com/canserberoofficial/aceptas",
                  answer: "Canserbero - Aceptas"
                },
                {
                  url: "https://soundcloud.com/canserberoofficial/sigo-siendo-el-rey",
                  answer: "Canserbero - Sigo Siendo el Rey"
                },
                {
                  url: "https://soundcloud.com/canserberoofficial/a-donde-se-fue-la-conciencia",
                  answer: "Canserbero - A Dónde se Fue la Conciencia"
                },
                {
                  url: "https://soundcloud.com/canserberoofficial/en-el-valle-de-las-sombras",
                  answer: "Canserbero - En el Valle de las Sombras"
                },
                {
                  url: "https://soundcloud.com/canserberoofficial/clima-tropical",
                  answer: "Canserbero - Clima Tropical"
                },
                {
                  url: "https://soundcloud.com/canserberoofficial/no-justice",
                  answer: "Canserbero - No Justice"
                },
                {
                  url: "https://soundcloud.com/canserberoofficial/seamos-honestos-mars-voice",
                  answer: "Canserbero And Nicojp - Seamos Honestos (Mars Voice Note)"
                },
                {
                  url: "https://soundcloud.com/canserberoofficial/visiones",
                  answer: "Canserbero - Visiones"
                },
                {
                  url: "https://soundcloud.com/canserberoofficial/epilogo-2",
                  answer: "Canserbero - Epílogo"
                },
                {
                  url: "https://soundcloud.com/canserberoofficial/hasta-cuando",
                  answer: "Canserbero And Apache - Hasta Cuándo"
                },
                {
                  url: "https://soundcloud.com/canserberoofficial/prologo",
                  answer: "Canserbero - Prólogo"
                },
                {
                  url: "https://soundcloud.com/canserberoofficial/la-voz",
                  answer: "Canserbero - La Voz"
                },
                {
                  url: "https://soundcloud.com/canserberoofficial/cancion-de-la-prision",
                  answer: "Canserbero - CANción de la Prisión"
                },
                {
                  url: "https://soundcloud.com/canserberoofficial/ouroboros",
                  answer: "Canserbero And Apache - Ouroboros"
                },
                {
                  url: "https://soundcloud.com/canserberoofficial/despierta",
                  answer: "Canserbero - Despierta"
                },
                {
                  url: "https://soundcloud.com/canserberoofficial/sin-mercy",
                  answer: "Canserbero - Sin Mercy"
                },
                {
                  url: "https://soundcloud.com/canserberoofficial/la-hora-del-juicio",
                  answer: "Canserbero - La Hora del Juicio"
                },
                {
                  url: "https://soundcloud.com/canserberoofficial/ni-de-oro-ni-goldfil",
                  answer: "Canserbero - Ni de Oro Ni GoldFil"
                },
                {
                  url: "https://soundcloud.com/canserberoofficial/les-guste-o-no",
                  answer: "Canserbero - Les Guste o No"
                },
                {
                  url: "https://soundcloud.com/canserberoofficial/can-you-hear-it",
                  answer: "Canserbero - CAN you hear it"
                },
                {
                  url: "https://soundcloud.com/canserberoofficial/prologo-1",
                  answer: "Canserbero - PROlogo"
                },
                {
                  url: "https://soundcloud.com/canserberoofficial/quien-eres",
                  answer: "Canserbero - Quién Eres"
                },
                {
                  url: "https://soundcloud.com/canserberoofficial/unetenos",
                  answer: "Canserbero - Únetenos"
                },
                {
                  url: "https://soundcloud.com/canserberoofficial/no-no",
                  answer: "Canserbero And Nicojp - No no"
                },
                {
                  url: "https://soundcloud.com/canserberoofficial/un-dia-en-el-barrio",
                  answer: "Canserbero - Un Día en el Barrio"
                },
                {
                  url: "https://soundcloud.com/canserberoofficial/corre",
                  answer: "Canserbero, Mcklopedia And Benzina - Corre"
                },
                {
                  url: "https://soundcloud.com/canserberoofficial/jeremias-17-5",
                  answer: "Canserbero - Jeremías 17-5"
                },
                {
                  url: "https://soundcloud.com/canserberoofficial/epilogo-2",
                  answer: "Canserbero - Epílogo"
                ...
                {
                  url: "https://soundcloud.com/canserberoofficial/interludio",
                  answer: "Canserbero And Apache - Interludio"
                },
                {
                  url: "https://soundcloud.com/canserberoofficial/monte-y-culebra",
                  answer: "Canserbero - Monte y Culebra"
                },
                {
                  url: "https://soundcloud.com/canserberoofficial/stop",
                  answer: "Canserbero And Apache - Stop"
                },
                {
                  url: "https://soundcloud.com/canserberoofficial/el-primer-trago",
                  answer: "Canserbero - El Primer Trago"
                },
                {
                  url: "https://soundcloud.com/canserberoofficial/manana-sera-otro-dia",
                  answer: "Canserbero - Mañana Será Otro Día"
                },
                {
                  url: "https://soundcloud.com/canserberoofficial/canbiate",
                  answer: "Canserbero - CANbiate"
                },
                {
                  url: "https://soundcloud.com/canserberoofficial/ready",
                  answer: "Canserbero And Apache Featuring Oldtape - Ready (feat. Oldtape)"
                },
                {
                  url: "https://soundcloud.com/canserberoofficial/ley-del-hielo",
                  answer: "Canserbero - Ley del Hielo"
                },
                {
                  url: "https://soundcloud.com/canserberoofficial/buenas-noches",
                  answer: "Canserbero And Nicojp - Buenas Noches"
                },
                {
                  url: "https://soundcloud.com/canserberoofficial/no-pueden-llamarse-muertos",
                  answer: "Canserbero - No Pueden Llamarse Muertos"
                },
                {
                  url: "https://soundcloud.com/canserberoofficial/apa-y-can",
                  answer: "Canserbero And Apache - Apa y Can"
                },
                {
                  url: "https://soundcloud.com/canserberoofficial/ni-de-oro-ni-de-goldfield",
                  answer: "Canserbero - Ni de Oro ni de Goldfield"
                },
                {
                  url: "https://soundcloud.com/canserberoofficial/from-the-roof",
                  answer: "Canserbero - From The Roof"
                },
                {
                  url: "https://soundcloud.com/canserberoofficial/on-datop",
                  answer: "Canserbero - On Datop"
                },
                {
                  url: "https://soundcloud.com/canserberoofficial/y-en-un-espejo-vi",
                  answer: "Canserbero - Y en un Espejo Vi"
                },
                {
                  url: "https://soundcloud.com/canserberoofficial/ra-words",
                  answer: "Canserbero And Nicojp - RA Words"
                },
                {
                  url: "https://soundcloud.com/canserberoofficial/interludio-k219",
                  answer: "Canserbero - Interludio K219"
                },
                {
                  url: "https://soundcloud.com/canserberoofficial/adivina",
                  answer: "Canserbero And Nicojp - Adivina"
                },
                {
                  url: "https://soundcloud.com/canserberoofficial/indigo",
                  answer: "Canserbero - Índigo"
                },
                {
                  url: "https://soundcloud.com/canserberoofficial/perdiendo-la-fe",
                  answer: "Canserbero - Perdiendo la Fe"
                },
                {
                  url: "https://soundcloud.com/canserberoofficial/agradezco",
                  answer: "Canserbero And Apache - Agradezco"
                },
                {
                  url: "https://soundcloud.com/canserberoofficial/epilogo-2",
                  answer: "Canserbero - Epílogo"
                ...
                {
                  url: "https://soundcloud.com/canserberoofficial/puno-arriba",
                  answer: "Canserbero - Puño Arriba"
                },
                {
                  url: "https://soundcloud.com/canserberoofficial/rialaif",
                  answer: "Canserbero - Rialaif"
                },
                {
                  url: "https://soundcloud.com/canserberoofficial/stupid-love-story",
                  answer: "Canserbero And Apache - Stupid Love Story"
                },
                {
                  url: "https://soundcloud.com/canserberoofficial/de-mi-muerte",
                  answer: "Canserbero - De Mi Muerte"
                },
                {
                  url: "https://soundcloud.com/canserberoofficial/darealhipapitis",
                  answer: "Canserbero - Darealhipapitis"
                },
                {
                  url: "https://soundcloud.com/canserberoofficial/hace-falta-sonar",
                  answer: "Canserbero - Hace Falta Soñar"
                },
                {
                  url: "https://soundcloud.com/canserberoofficial/americanos",
                  answer: "Canserbero - Americanos"
                },
                {
                  url: "https://soundcloud.com/canserberoofficial/ponmela-en-el-aire",
                  answer: "Canserbero And Apache - Pónmela en el Aire"
                },
                {
                  url: "https://soundcloud.com/canserberoofficial/mundo-de-piedra",
                  answer: "Canserbero - Mundo de Piedra"
                }
            ],
            Pn
        ).subscribe,
    ...
    function En(e) {
        let a, l, u, c, d, h, f, m, v, k, _, b, $, D, Y, C, O, P, A;
        G(e[18]),
            (l = new me({
                props: {
    ...
    function jn(e, t, n) {
        ...
        null == localStorage.getItem("canserberoUserStats") ?
            ((h = []), localStorage.setItem("canserberoUserStats", JSON.stringify(h))) :
            (h = JSON.parse(localStorage.getItem("canserberoUserStats"))),
            (f = h.find((e) => e.id === l.id)),
            void 0 === f &&
            ((f = l),
                h.push(f),
                localStorage.setItem("canserberoUserStats", JSON.stringify(h)));
        let g,
            y,
            v = f.guessList,
            w = {
        ...
        null == localStorage.getItem("firstTime") &&
            (_("help", "como jugar"), localStorage.setItem("firstTime", "false"));
        return [
            i,
            o,
            l,
