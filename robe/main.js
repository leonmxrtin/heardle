var app = (function() {
        ...
        return (
            (u = new Bt({})), {
                c() {
                    ...
                    (s = w("p")),
                    (s.innerHTML =
                        'También puedes visitar el <a href="https://heardle.leonmartin.cc/extremoduro/?utm_source=robe-heardle&utm_medium=banner">Heardle de Extremoduro</a>'),
                    (i = x()),
                    (o = w("div")),
                    //Q(a.$$.fragment),
                    (l = x()),
            ...
            (S = new qt({})), {
                c() {
                    ...
                    W.c(),
                        ...
                        (Y = w("div")),
                        (Y.innerHTML =
                            '<p>Te ha gustado? Juega al <a href="https://heardle.leonmartin.cc/extremoduro/?utm_source=robe-heardle&utm_medium=banner">Heardle de Extremoduro</a> :-)</p>'),
                        (C = x()),
            ...
            [
                ...
                () => {
                    ...
                    let o =
                        ...
                        t +
                        "\n\n" +
                        "@donRobeIniesta @extremofrase" +
                        "\n\n" +
                        "https://heardle.leonmartin.cc/robe/";
                    if (
                        !navigator.share ||
    ...
    function jn(e, t, n) {
        ...
        null == localStorage.getItem("robeUserStats") ?
            ((h = []), localStorage.setItem("robeUserStats", JSON.stringify(h))) :
            (h = JSON.parse(localStorage.getItem("robeUserStats"))),
            (f = h.find((e) => e.id === l.id)),
            void 0 === f &&
            ((f = l),
                h.push(f),
                localStorage.setItem("robeUserStats", JSON.stringify(h)));
        let g,
            y,
            v = f.guessList,
            w = {
